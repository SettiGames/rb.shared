...
(function (RB) {
    ...
    var UserRankingKey;
    (function (UserRankingKey) {
        UserRankingKey["rating"] = "rankings:users:rating";
        UserRankingKey["games"] = "rankings:users:games";
        UserRankingKey["wins"] = "rankings:users:wins";
        UserRankingKey["loses"] = "rankings:users:loses";
        UserRankingKey["fivers"] = "rankings:users:fivers";
        UserRankingKey["trophies"] = "rankings:users:trophies";
        UserRankingKey["distance"] = "rankings:users:distance";
        UserRankingKey["fishCaught"] = "rankings:users:fishCaught";
        UserRankingKey["earnings"] = "rankings:users:earnings";
        UserRankingKey["treasure"] = "rankings:users:treasure";
        UserRankingKey["doubloons"] = "rankings:users:doubloons";
        UserRankingKey["attackSuccess"] = "rankings:users:attackSuccess";
        UserRankingKey["attacks"] = "rankings:users:attacks";
        UserRankingKey["fishStolen"] = "rankings:users:fishStolen";
        UserRankingKey["moneyStolen"] = "rankings:users:moneyStolen";
        UserRankingKey["defenseSuccess"] = "rankings:users:defenseSuccess";
        UserRankingKey["defends"] = "rankings:users:defends";
        UserRankingKey["collisions"] = "rankings:users:collisions";
    })(UserRankingKey = RB.UserRankingKey || (RB.UserRankingKey = {}));
    var VesselStatKey;
