...
(function (RB) {
    ...
    (function (PlayerStatKey) {
        PlayerStatKey["rating"] = "rating";
        PlayerStatKey["ratingsDelta"] = "ratingsDelta";
        PlayerStatKey["games"] = "games";
        PlayerStatKey["wins"] = "wins";
        PlayerStatKey["loses"] = "loses";
        PlayerStatKey["trophies"] = "trophies";
        PlayerStatKey["fivers"] = "fivers";
        ...
        PlayerStatKey["treasureCount"] = "treasureCount";
        ...
        PlayerStatKey["defends"] = "defends";
        PlayerStatKey["collisions"] = "collisions";
        PlayerStatKey["turnLengths"] = "turnLengths";
    })(PlayerStatKey = RB.PlayerStatKey || (RB.PlayerStatKey = {}));
    var PlayerRankingKey;
    (function (PlayerRankingKey) {
        PlayerRankingKey["rating"] = "rankings:players:rating";
        PlayerRankingKey["games"] = "rankings:players:games";
        PlayerRankingKey["wins"] = "rankings:players:wins";
        PlayerRankingKey["loses"] = "rankings:players:loses";
        PlayerRankingKey["fivers"] = "rankings:players:fivers";
        PlayerRankingKey["trophies"] = "rankings:players:trophies";
        PlayerRankingKey["distance"] = "rankings:players:distance";
        PlayerRankingKey["fishCaught"] = "rankings:players:fishCaught";
        PlayerRankingKey["earnings"] = "rankings:players:earnings";
        PlayerRankingKey["treasure"] = "rankings:players:treasure";
        PlayerRankingKey["doubloons"] = "rankings:players:doubloons";
        PlayerRankingKey["attackSuccess"] = "rankings:players:attackSuccess";
        PlayerRankingKey["attacks"] = "rankings:players:attacks";
        PlayerRankingKey["fishStolen"] = "rankings:players:fishStolen";
        PlayerRankingKey["moneyStolen"] = "rankings:players:moneyStolen";
        PlayerRankingKey["defenseSuccess"] = "rankings:players:defenseSuccess";
        PlayerRankingKey["defends"] = "rankings:players:defends";
        PlayerRankingKey["collisions"] = "rankings:players:collisions";
    })(PlayerRankingKey = RB.PlayerRankingKey || (RB.PlayerRankingKey = {}));
    var VesselStatKey;
    (function (VesselStatKey) {
        ...
        VesselStatKey["doubloons"] = "doubloons";
        VesselStatKey["treasureCount"] = "treasureCount";
        VesselStatKey["attackSuccess"] = "attackSuccess";
        VesselStatKey["attackFail"] = "attackFail";
        VesselStatKey["attacks"] = "attacks";
    ...
    (function (VesselRankingKey) {
        ...
        VesselRankingKey["earnings"] = "rankings:vessels:earnings";
        VesselRankingKey["treasure"] = "rankings:vessels:treasure";
        VesselRankingKey["doubloons"] = "rankings:vessels:doubloons";
        VesselRankingKey["attackSuccess"] = "rankings:vessels:attackSuccess";
        VesselRankingKey["attacks"] = "rankings:vessels:attacks";
        VesselRankingKey["fishStolen"] = "rankings:vessels:fishStolen";
        VesselRankingKey["moneyStolen"] = "rankings:vessels:moneyStolen";
        VesselRankingKey["defenseSuccess"] = "rankings:vessels:defenseSuccess";
